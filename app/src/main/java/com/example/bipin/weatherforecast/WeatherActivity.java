...
import entity.WeatherObject;
import helpers.CustomSharedPreference;
import helpers.Helper;
import json.FiveDaysForecast;
import json.FiveWeathers;
import json.Forecast;
...
public class WeatherActivity extends AppCompatActivity implements LocationListener {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            if (isLocationSaved.equals("")) {
                ...
                if (locationManager != null) {
                    ...
                    apiUrl = "http://api.openweathermap.org/data/2.5/weather?lat=" + location.getLatitude() + "&lon=" + location.getLongitude() + "&APPID=" + "2c02302abbf3630faf14d00d09b1a85c" + "&units=metric";
                ...
                if (!TextUtils.isEmpty(city[0])) {
                    ...
                    String url = "http://api.openweathermap.org/data/2.5/weather?q=" + city[0] + "&APPID=" + "2c02302abbf3630faf14d00d09b1a85c" + "&units=metric";
                    makeJsonObject(url);
                }
            }
        }
            ...
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED && grantResults[1] == PackageManager.PERMISSION_GRANTED) {
                ...
                if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                    ...
                    if (locationManager != null) {
                        ...
                        apiUrl = "http://api.openweathermap.org/data/2.5/weather?lat=51.5074&lon=0.1278&APPID=" + "2c02302abbf3630faf14d00d09b1a85c" + "&units=metric";
                        makeJsonObject(apiUrl);
                    }
                }
            } else {
    ...
    private void fiveDaysApiJsonObjectCall(String city) {
        String apiUrl = "http://api.openweathermap.org/data/2.5/forecast?q=" + city + "&APPID=" + "2c02302abbf3630faf14d00d09b1a85c" + "&units=metric";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_settings:
                Intent listLocationIntent = new Intent(this, ListLocationActivity.class);
