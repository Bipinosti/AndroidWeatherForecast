...
public class AddLocationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goBackButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent backIntent = new Intent(AddLocationActivity.this, WeatherActivity.class);
        ...
        addLocationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent listLocationIntent = new Intent(AddLocationActivity.this, ListLocationActivity.class);
                listLocationIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(listLocationIntent);
            }
        });
    }
